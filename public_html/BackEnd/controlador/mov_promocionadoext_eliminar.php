...
// Invocar CRUD
$lb_result = $crud->fila_eliminar(DEF_TABLA_PROMOCIONEXTPROG, $array_campo_pk, $array_valor_pk);

// ======================================= FIN CRUD ELIMINAR =========================================== //

// Redireccionar
if($lb_result == true) {
	header("Location: ../vista/mov_promocionadoext_lista.php?id_codigo_padre=".$li_codigo_padre);
}
else {
	header("Location: ../vista/mov_promocionadoext_editar.php?id_codigo_padre=".$li_codigo_padre."&id_codigo=".$li_codigo);
}
