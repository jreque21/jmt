...
if ( $li_contador > 0 ) {
	$ls_mensaje	= 'Sede se encuentra referenciado en Maestra de Estudiantes.';
}
if ($li_contador == 0) {
	$li_contador = $crud->fila_contar(DEF_TABLA_SEDEINSTRUCTOR, $array_campo_pk, $array_valor_pk);
	if ( $li_contador > 0 ){
		$ls_mensaje	= 'Sede se encuentra referenciado en Instructores por Sede.';
	}
}
