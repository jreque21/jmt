...
if(isset($_POST) && !empty($_POST)){
	...
	$li_cuenta = $crud->fila_contar(DEF_TABLA_PROMOCIONPROG, $array_campo_pk, $array_valor_pk);
	...
	if ($lb_result == true) {
		...
		// Invocar inserción
		$lb_result = $crud->fila_registrar(DEF_TABLA_PROMOCIONPROG, $array_campo, $array_valor, '0');
	...
	if($lb_result == true) {
		...
		header("Location: ../vista/mov_promocionado_nuevo.php?id_codigo_padre=".$li_cod_promocion."&id_respuesta='".$ls_mensaje."'"); 
	}
