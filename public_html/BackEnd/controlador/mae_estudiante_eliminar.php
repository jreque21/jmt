...
if ( $li_contador > 0 ) {
	$ls_mensaje	= 'Estudiante se encuentra referenciado en registros de matrícula.';
}
if ($li_contador == 0) {
...
if ( $li_contador > 0 ) {
	// Redireccionar
	if($lb_form == true) {
		header("Location: ../vista/mae_estudiante_editar.php?id_codigo=".$li_codigo."&id_msgRpta=".$ls_mensaje);
	} else {
...
if($lb_result == true) {
	...
	header("Location: ../vista/mae_estudiante_editar.php?id_codigo=".$li_codigo);
}
