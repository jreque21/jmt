...
if(isset($_GET['id_codigo'])){
	...
	$array_valor_pk	= array(DEF_TIPOUSER_INST, $li_codigo, '1');
	...
	$ls_clave		= $crud->fila_recuperar_campo(DEF_TABLA_INSTRUCTOR, $array_campo_pk, $array_valor_pk, 'V_NRO_DOC');
	...
	$lb_result = $crud->ejecutar_sp("call sp_generar_usuario('USER_INST','$li_codigo','$ls_clave','$ls_user')");
