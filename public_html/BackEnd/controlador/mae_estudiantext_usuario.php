...
if(isset($_GET['id_codigo'])){
	...
	$array_valor_pk	= array(DEF_TIPOUSER_ESTEXT, $li_codigo, '1');

	// Invocar CRUD
	$li_contador = $crud->fila_contar(DEF_TABLA_USUARIO, $array_campo_pk, $array_valor_pk);
	if ( $li_contador > 0 ) {
		$ls_mensaje	= 'Estudiante Externo ya tiene registrado un usuario.';
	...
	$lb_result = $crud->ejecutar_sp("call sp_generar_usuario('EST_EXT','$li_codigo','$ls_clave','$ls_user')");
