...
if($lb_result == true) {
	$lb_result = $crud->f_update_saldoPendiente($li_codigo_padre);
}
...
// Redireccionar
if($lb_result == true) {
	header("Location: ../vista/mov_pago_lista.php?id_codigo_padre=".$li_codigo_padre);
}
else {
	header("Location: ../vista/mov_pago_editar.php?id_codigo_padre=".$li_codigo_padre."&id_codigo=".$li_codigo);
}
