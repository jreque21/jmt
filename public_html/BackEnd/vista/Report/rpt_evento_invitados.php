...
$pdf->SetTitle("Lista de Invitados");	// Titulo

// BODY 
// =========================================================
// Titulo
$pdf->SetFont('Helvetica','B',16);
$pdf->Cell(0,0,'LISTA DE INVITADOS',0, 0,'C',false);
$pdf->Ln(8);
...
$pdf->Cell(30,8,utf8_decode('Móvil'), 1, 0,'C',true);
$pdf->Ln(8);
...
while ($row = mysqli_fetch_assoc($array_lista)) {	
	...
	$pdf->Cell(30,8, $row_padron['V_MOVIL'], 'B', 1,'C',true);

}

// Ver reporte en pantalla
$pdf->Output('rpt_evento_invitados.pdf','i');
