...
function f_listado($as_titulo, $as_icono, $as_msgRpta){
	...
	// Enlaces
	$url_nuevo		= "mae_instructor_nuevo.php";
	$url_editar		= "mae_instructor_editar.php";
	$url_lista		= "mae_instructor_lista.php";
	$url_prog		= "../controlador/mae_instructor_usuario.php";
	$url_eliminar	= "../controlador/mae_instructor_eliminar.php";
	...
	// Listado
	$array = $crud->fila_listar(DEF_TABLA_INSTRUCTOR, $array_campo_pk, $array_valor_pk, 'V_APE_PATERNO, V_APE_MATERNO, V_NOMBRES', 'A', 0, 100);
									...
									<table id="lista" class="table table-striped table-bordered table-hover">
										...
										<tbody>
											...
											while ($row = mysqli_fetch_assoc($array)) {
												$url_editar_fila   = $url_editar."?id_codigo=".($row["N_COD_INSTRUCTOR"]);
												$url_prog_fila	   = $url_prog."?id_codigo=".($row["N_COD_INSTRUCTOR"]);
												$url_eliminar_fila = $url_eliminar."?id_codigo=".($row["N_COD_INSTRUCTOR"]);
												?>
												<tr>
													<?php

													echo "<td>";
													echo f_r_url($url_editar_fila, $row["N_COD_INSTRUCTOR"],$row["V_NOMBRES"]);
													echo "</td>";
													...
													$array_valor_pk	= array(DEF_TIPOUSER_INST, $row["N_COD_INSTRUCTOR"], '1');
													...
													echo "<td align='center'>";
													?>
													<a href="#deleteModal<?php echo $row["N_COD_INSTRUCTOR"]; ?>" data-toggle="modal" ><i class="fa fa-trash-o"></i></a>
													<div id="deleteModal<?php echo $row["N_COD_INSTRUCTOR"]; ?>" class="modal fade">
...
function f_formulario($as_titulo, $as_icono, $as_msgRpta, $array = "") {
	...
	// Enlaces
	$url_lista		= "mae_instructor_lista.php";
	$url_registrar	= "../controlador/mae_instructor_registrar.php";
	$url_actualizar	= "../controlador/mae_instructor_actualizar.php";
	$url_eliminar	= "../controlador/mae_instructor_eliminar.php";
							...
							<form  id="form_mtto" role="form" method="post" action="" enctype="multipart/form-data" autocomplete="ofF">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="id_codigo" name="id_codigo" maxlength="5" disabled
														title = "Generado por el sistema" placeholder="Codigo autogenerado" value="<?php echo $lb_edit?$array["N_COD_INSTRUCTOR"]:""; ?>">
												</div>
											</div>
											<div class="col-sm-6">
												<div class="form-group">
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="id_ape_paterno" name="id_ape_paterno" maxlength="150" required pattern="[A-Za-zñÑáéíóúÁÉÍÓÚ\s0-9 ]{1,150}" 
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="id_ape_materno" name="id_ape_materno" maxlength="150" required pattern="[A-Za-zñÑáéíóúÁÉÍÓÚ\s0-9 ]{1,150}" 
									...
									<div class="col-sm-4 text-center">
										<div class="form-group">			
											<?php if($lb_edit){
												...
												<img class="img-responsive img-thumbnail" src="../../upload/<?php echo DEF_UPLOAD_INSTRUCTOR_DIR.'/'.$array["V_FOTO"];?>" width="160px">
												<?php
												}	
											}?>
										</div>
								...
								<div class="row">
									...
									<div class="col-sm-8">
										...
										<input type="text" class="form-control" id="id_motivo_baja" name="id_motivo_baja" maxlength="150" pattern="[A-Za-zñÑáéíóúÁÉÍÓÚ\s0-9 -_]{1,150}" 
										title = "Letras y Números. Tamaño máximo: 150" placeholder="Ejemplo : Renuncia" value="<?php echo $lb_edit?$array["V_MOTIVO_BAJA"]:""; ?>">
									</div>
								</div>	
								...
								<?php
								if ($lb_edit) {
									echo "<input type=hidden name=id_codigo value=\"".$array["N_COD_INSTRUCTOR"]."\">";
									?>
