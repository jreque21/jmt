...
require_once(DEF_PATH_HTML_CINTURON);
...
$array_valor_pk	= array(DEF_TABLA_CINTURON);
...
if ($id){
	...
	// Invocar fila
	$array = $crud->fila_recuperar(DEF_TABLA_CINTURON, $array_campo_pk, $array_valor_pk);
