...
function f_listado($as_titulo, $as_icono, $as_msgRpta){
	...
	// Enlaces
	$url_nuevo		= "mae_estudiante_nuevo.php";
	$url_editar		= "mae_estudiante_editar.php";
	$url_lista		= "mae_estudiante_lista.php";
	$url_prog		= "../controlador/mae_estudiante_usuario.php";
	$url_eliminar	= "../controlador/mae_estudiante_eliminar.php";
	$url_reporte	= "Report/rpt_estudiante_det.php";
									...
									<table id="lista" class="table table-striped table-bordered table-hover">
										...
										<tbody>
											...
											while ($row = mysqli_fetch_assoc($array)) {
												...
												$url_reporte_fila  = $url_reporte."?id_codigo=".($row["N_COD_ESTUDIANTE"]);
												?>
												<tr>
													<?php
													...
													$array_valor_pk	= array(DEF_TIPOUSER_ESTINT, $row["N_COD_ESTUDIANTE"], '1');
													...
													<a href="<?php echo $url_reporte_fila?>" target="_blank" >
														<i class="fa fa-file-pdf-o" title = "Ver Ficha de Estudiante"></i>
													</a>
													<?php
													echo "</td>";
...
function f_formulario($as_titulo, $as_icono, $as_msgRpta, $array = "") {
	...
	// Enlaces
	$url_lista		= "mae_estudiante_lista.php";
	$url_registrar	= "../controlador/mae_estudiante_registrar.php";
	$url_actualizar	= "../controlador/mae_estudiante_actualizar.php";
	$url_eliminar	= "../controlador/mae_estudiante_eliminar.php";
