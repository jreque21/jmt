...
require_once(DEF_PATH_HTML_SEDEINSTRUCTOR);
...
$array_valor_pk	= array(DEF_TABLA_SEDEINSTRUCTOR);
...
if ($id){
	...
	$lb_result = $crud->ejecutar_sp("call sp_generar_sedeinstructor('$id','$ls_user')");
	
	// Abrir formulario
	f_formulario($array_opcion['V_ETIQUETA'], $array_opcion['V_ICONO'], $ls_msgRpta, $id);
