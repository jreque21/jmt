...
require_once(DEF_PATH_HTML_INSTRUCTOR);
...
$array_valor_pk	= array(DEF_TABLA_INSTRUCTOR);
...
if ($id){
	...
	// Invocar fila
	$array = $crud->fila_recuperar(DEF_TABLA_INSTRUCTOR, $array_campo_pk, $array_valor_pk);
