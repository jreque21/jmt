...
require_once(DEF_PATH_HTML_TIPOGRADO);
...
$array_valor_pk	= array(DEF_TABLA_TIPOGRADO);
...
if ($id){
	...
	// Invocar fila
	$array = $crud->fila_recuperar(DEF_TABLA_TIPOGRADO, $array_campo_pk, $array_valor_pk);
