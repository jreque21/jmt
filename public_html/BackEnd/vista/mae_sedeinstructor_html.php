...
function f_listado($as_titulo, $as_icono, $as_msgRpta){
	...
	// Enlaces
	$url_editar		= "mae_sedeinstructor_editar.php";
	$url_lista		= "mae_sedeinstructor_lista.php";
											...
											while ($row = mysqli_fetch_assoc($array)) {
												...
												<tr>
													...
													echo "<td>";
														...
														$li_cantidad	= $crud->fila_contar(DEF_TABLA_SEDEINSTRUCTOR, $array_campo_pk, $array_valor_pk);
														echo $li_cantidad;
													echo "</td>";
...
function f_formulario($as_titulo, $as_icono, $as_msgRpta, $id = "") {
	...
	// Listado
	$array = $crud->fila_listar(DEF_TABLA_SEDEINSTRUCTOR, $array_campo_pk, $array_valor_pk, 'N_COD_INSTRUCTOR', 'A', 0, 100);
	...
	<script>
		$(function(){
			$('body').on('click', '#detalle input[type=checkbox]', function(event){
				...
				$.ajax({
						data:  parametros,
						url:   '../controlador/mae_sedeinstructor_actualizar.php',
						type:  'post',
						beforeSend: function () {
